...
参数表
'''
start_x, start_y, start_z = 500, -177, 377
end_x, end_y, end_z = 500, -177, 500
...
class SiasunRobotPythonInterface(object):
    ...
    def move_to_safe_position(self):
        ...
        safe_pos = [400, 0, 500]  # x=400mm, y=0mm, z=500mm
        safe_orient = [180, 0, 0]  # rx=180度, ry=0度, rz=0度
...
if __name__ == '__main__':
    ...
    print("开始移动机械臂到初位置")
    robot.move_to_absolute_position(start_x, start_y, start_z, motion_type = 'joint')
    time.sleep(5)
    ...
    print("开始移动机械臂到末位置")
    robot.move_to_absolute_position(end_x, end_y, end_z, motion_type = 'joint')
    time.sleep(5)
